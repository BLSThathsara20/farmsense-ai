...
import {
	ProfitCounter,
	ScoreCounter,
} from "../components/landing/ProfitCounter";

const weekPlan = [
	{
		week: "Now",
		action: "Check your soil",
		detail: "N, P, K and pH — takes 2 minutes",
	},
	{
		week: "Week 3–4",
		action: "Sow tomato",
		detail: "Best match for your land right now",
	},
	{
		week: "Week 8–10",
		action: "Sell",
		detail: "Price window opening — don't miss it",
	},
];
	...
	return (
		<div className="landing-page min-h-dvh bg-bg dark:bg-bg-dark overflow-x-hidden ek-page-grain">
				...
				<div className="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
					<motion.div {...fadeUp} transition={{ duration: 0.35 }}>
						<p className="landing-eyebrow mb-4">
							<Sun
								className="h-3.5 w-3.5 inline -mt-0.5 mr-1.5 text-accent"
								aria-hidden="true"
							/>
						...
						<div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-2">
							<Link to="/register" className="flex-1 sm:flex-none">
								<Button
									size="lg"
									className="w-full sm:w-auto landing-cta-primary"
								>
									Get my crop plan
					...
					>
						<div className="landing-plan-card">
							...
							<div className="flex items-start justify-between gap-3 mb-5">
								...
								<div
									...
									aria-label="92 percent suitability"
								>
							...
							<div className="landing-plan-reason">
								<p className="text-sm text-text-secondary dark:text-text-dark-secondary leading-snug">
									...
									Your soil pH and nutrients fit. Prices rising. Low oversupply
									in your district.
								</p>
							</div>
						</div>
						...
						<div className="mt-3 flex items-center justify-center gap-2">
							<DemoTag />
							<p className="text-center text-xs text-text-muted dark:text-text-dark-muted font-mono">
								Example prototype output for an illustrative small farm
							</p>
						</div>
					</motion.div>
				</div>
			...
			<section
				ref={storyRef}
				id="how-it-works"
				className="relative px-5 py-14 lg:py-20"
			>
