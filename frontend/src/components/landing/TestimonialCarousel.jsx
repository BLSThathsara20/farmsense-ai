...
const testimonials = [
	{
		id: 1,
		quote:
			"Prototype scenario: one screen before breakfast is easier than checking several sources.",
		author: "Example farmer",
		role: "Illustrative user journey",
		region: "Prototype persona",
	},
	{
		id: 2,
		quote:
			"Prototype scenario: the market screen highlights when a stronger sell window may be opening.",
		author: "Example farmer",
		role: "Illustrative user journey",
		region: "Prototype persona",
	},
	{
		id: 3,
		quote:
			"Prototype scenario: simple setup and a clear sow/sell plan matter for low-effort use.",
		author: "Example farmer",
		role: "Illustrative user journey",
		region: "Prototype persona",
	},
	...
	return (
		...
		>
			...
			<div className="flex gap-5 mt-6 pt-6 border-t border-border/50 dark:border-border-dark/50 text-sm font-mono text-text-secondary dark:text-text-dark-secondary">
				<span>
					<strong className="text-primary">Demo</strong> personas
				</span>
				<span>
